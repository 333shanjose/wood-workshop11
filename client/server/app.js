...
const uri= "mongodb+srv://shan-21:shan123456@e-commerce.thjtswe.mongodb.net/?retryWrites=true&w=majority"
...

{
  ...
  app.post('/place-order',(req,res)=>{
     console.log(req.body)
      db.collection('order').insertMany([req.body])
    })
  ...
  app.get('/admin/login',async(req,res)=>{
   ...
   let admins=await db.collection('admin').findOne()   
   res.json({admins}) 
})
...
app.post('/admin/editproducts/:id',upload.single('image'),(req,res)=>{
   ...
   dbs.updateOne(req.params.id,req.body,req.file).then(()=>{
  })
