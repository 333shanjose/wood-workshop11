...
function Adminhead() {
  ...
  return (
    <>
    <html lang="en" class="light-style layout-navbar-fixed layout-compact layout-menu-fixed layout-menu-collapsed layout-menu-hover" dir="ltr" data-theme="theme-default" data-assets-path="../../assets/" data-template="vertical-menu-template">
    <aside id="layout-menu" class="layout-menu menu-vertical menus bg-menu-theme" data-bg-class="bg-menu-theme" style={{touchaction:'none', userselect:'none',webkituserdrag:'none',webkittaphighlightcolor: 'rgba(0, 0, 0, 0)'}}>
...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
  ...
  <li class={isActive ? 'menu-item active open' : 'menu-item active'}>
  
      <a href="javascript:void(0);" class="menu-link menu-toggle" onClick={Name}>
      ...
      <ul class="menu-sub">
        ...
        <li class={isActivee ? 'menu-item active open' : 'menu-item active'} onClick={Names}>
        ...
        <li class={isActivees ? 'menu-item active open' : 'menu-item active'} onClick={Namess}>
          <a href="javascript:void(0);" class="menu-link menu-toggle">
